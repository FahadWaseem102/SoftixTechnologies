    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                alertDialog.setMessage("Enter your name here:");
                alertDialog.setIcon(R.drawable.ic_users_dialog) ;
                adapter = new ArrayAdapter<String>(UsersActivity.this, android.R.layout.simple_expandable_list_item_1,addArray) ;
                listView.setAdapter(adapter);

                final EditText input = new EditText(UsersActivity.this);
                final EditText inputBlnc = new EditText(UsersActivity.this);
                input.setHint("User name");
                input.setHintTextColor(getResources().getColor(R.color.colorHintText));
                inputBlnc.setHint("Group");
                inputBlnc.setHintTextColor(getResources().getColor(R.color.colorHintText));

                LinearLayout layout = new LinearLayout(UsersActivity.this);
